...
class GetActResponse implements ResultInterface
{
     ...
     * @return string
     */
    public function getFastAktivitet()
    {
        return $this->FastAktivitet;
    }

    /**
     * @param string $FastAktivitet
     * @return $this
     */
    public function setFastAktivitet($FastAktivitet)
    {
        $this->FastAktivitet = $FastAktivitet;
        return $this;
    }
